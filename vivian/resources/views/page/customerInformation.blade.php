                        ...
                        <div class="fieldset">
                          <div class="field field--required">
                            ...
                            <div class="field__input-wrapper">
                              <input placeholder="Email" autocapitalize="off" spellcheck="false" autocomplete="shipping email" data-trekkie-id="email_field" data-autofocus="true" data-backup="customer_email" aria-describedby="checkout-context-step-one" aria-required="true" class="field__input" size="30" type="email" value="" name="email" id="checkout_email" />
                            </div>
                          </div>
                        </div>
                      </div> 
                      ...
                      <div class="section__content">
                        <div class="fieldset" data-address-fields>
                          ...
                          <div class="field--half field field--optional" data-address-field="first_name">
                            ...
                            <div class="field__input-wrapper">
                              <input placeholder="Full name" autocomplete="shipping given-name" data-trekkie-id="shipping_firstname_field" data-backup="first_name" class="field__input" size="50" type="text" value="ads" name="fullName" id="checkout_shipping_address_first_name" />
                            </div>
                          </div>
                          ...
                          <div class="field--half field field--optional" data-address-field="first_name">
                            ...
                            <div class="field__input-wrapper">
                              <input placeholder="Gender" autocomplete="shipping given-name" data-trekkie-id="shipping_firstname_field" data-backup="first_name" class="field__input" size="30" type="text" value="" name="gender" id="checkout_shipping_address_first_name" />
                            </div>
                          </div>
                        ...
                        <div class="section__content">
                          <fieldset class="content-box">
                            <div class="radio-wrapper content-box__row" data-same-billing-address>
                              <div class="radio__input">
                                <input class="input-radio" data-backup="different_billing_address_false" data-trekkie-id="same_billing_address_field" type="radio" value="false" checked="checked" name="payment" id="checkout_different_billing_address_false" />
                              </div>
                            ...
                            <div class="radio-wrapper content-box__row" data-different-billing-address>
                              <div class="radio__input">
                                <input class="input-radio" data-backup="different_billing_address_true" data-trekkie-id="different_billing_address_field" aria-expanded="true" aria-controls="section--billing-address__different" type="radio" value="true" name="payment" id="checkout_different_billing_address_true" />
                              </div>
                              <a href="https://www.baokim.vn/payment/product/version11?business=tducnguyen1997%40gmail.com&id=&order_description=La+mot+cai+vay&product_name=COTTON+COLORBLOCK&product_price=570000&product_quantity=1&total_amount=570000&url_cancel=&url_detail=&url_success="><img src="http://www.baokim.vn/developers/uploads/baokim_btn/" alt="Thanh toán an toàn với Bảo Kim !" border="0" title="Thanh toán trực tuyến an toàn dùng tài khoản Ngân hàng (VietcomBank, TechcomBank, Đông Á, VietinBank, Quân Đội, VIB, SHB,... và thẻ Quốc tế (Visa, Master Card...) qua Cổng thanh toán trực tuyến BảoKim.vn" ></a>
                          </fieldset>
                        </div> 
                      </div>
