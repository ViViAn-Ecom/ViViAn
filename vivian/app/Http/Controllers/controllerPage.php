...
/*
   ...
   public function getDeleteCart($id){
    ...
    public function getBlog(){
        ...
        //$post=person_post_new::where('id','=',$Post_id)->get();
        //$likePost=person_post_new::find($Post_id);
        //$like=Likes::where(['id_person'=>$likePost->id])->count();
        ...
        // $parent=users::where('id_user',$same->id_user)->get();
         //if ($request->ajax()){
               ...
               // return view('page.commentlist', ['person_post_new'=>$testcmt]);
          //  }
        return view('page.blog',compact('persons','testcmt'));
    }
